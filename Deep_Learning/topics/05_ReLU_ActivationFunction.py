...
DISPLAY_NAME = "05 . Activation_Function_Explanation"
ICON         = "🚨"
SUBTITLE     = "Activation Function Explanation"
...
print("=" * 55)
_col1 = "σ\'(z)"
print(f"{'z':>6} | {'σ(z)':>8} | {_col1:>8} | Interpretation")
print("-" * 55)
for z in z_values:
    s = sigmoid(z)
...
_col2 = "tanh\'(z)"
_col3 = "σ\'(z)"
print(f"{'z':>6} | {'tanh(z)':>8} | {_col2:>9} | {'σ(z)':>8} | {_col3:>8}")
print("-" * 70)
...
print("=" * 50)
_col4 = "ReLU\'(z)"
print(f"{'z':>6} | {'ReLU(z)':>8} | {_col4:>9} | Status")
print("-" * 50)
for z in z_values:
    r = relu(z)
    d = relu_derivative(z)
...
_col5 = "ReLU\'"
_col6 = "Leaky\'"
print(f"{'z':>6} | {'ReLU':>6} | {_col5:>6} | {'Leaky':>8} | {_col6:>7} | Dead?")
print("-" * 70)
...
print("=" * 55)
_col7 = "ELU\'(z)"
print(f"{'z':>6} | {'ELU(z)':>8} | {_col7:>8} | Note")
print("-" * 55)
for z in z_values:
    e = elu(z)
    d = elu_derivative(z)
...
print("=" * 55)
_col8 = "Swish\'"
print(f"{'z':>6} | {'Swish':>8} | {'ReLU':>6} | {_col8:>8}")
print("-" * 40)
for z in z_values:
    sw = swish(z)
    r = max(0, z)
...
_col13 = "ELU'"
_col14 = "Swish'"
print(f"{'z':>5} | {'Step':>5} | {_col9:>6} | {_col10:>6} | "
      f"{_col11:>6} | {_col12:>7} | {_col13:>6} | {_col14:>7}")
print("-" * 80)
for z in z_values:
...
def get_content():
    ...
    from Deep_Learning.visuals.relu_visual import RELU_VISUAL_HTML, RELU_VISUAL_HEIGHT
    ...
    return {
        ...
        "visual_html": RELU_VISUAL_HTML,        # Interactive XOR component
