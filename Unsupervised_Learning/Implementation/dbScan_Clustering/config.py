...
# PATHS
# ─────────────────────────────────────────────
# BASE_DIR resolves to the Classification/ directory (where this file lives)
BASE_DIR   = os.path.dirname(os.path.abspath(__file__))

# All folders are created inside Classification/
...
for _dir in [DATA_DIR, PLOT_DIR, REPORT_DIR]:
